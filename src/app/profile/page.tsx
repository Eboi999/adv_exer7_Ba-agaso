...
const Profile = () => {
    ...
    return (
        <div className="h-screen max:h-screen-auto flex justify-center items-center bg-background">
            <div className="w-1/2 rounded-md bg-box-color flex justify-between flex-col font-serif">
                <div className="h-28 w-full justify-center flex items-center">
                    <span className="text-3xl text-white font-serif font-semibold p-3 rounded-lg">Welcome Back {userInfo?.displayName}</span>
                </div>
                ...
                <div className="flex w-full items-center justify-around my-4">
                    <span className="cursor-pointer py-1 px-2 bg-custom-btn rounded-md text-white" onClick={()=>setVisibility("profile")}>Update Profile</span>
                    <span className="cursor-pointer py-1 px-2 bg-custom-btn rounded-md text-white" onClick={()=>setVisibility("password")}>Change Password</span>
                </div>

                {visibleForm === 'profile' &&
                    <>
                        <div className="h-28 w-full justify-center flex items-center">
                            <span className="text-3xl text-black font-serif font-semibold bg-yellow-300 p-3 rounded-lg">Update Profile</span>
                        </div>
                ...
                <>
                    <div className="h-28 w-full justify-center flex items-center">
                        <span className="text-3xl text-black font-serif font-semibold bg-yellow-300 p-3 rounded-lg">Change Password</span>
                    </div>
